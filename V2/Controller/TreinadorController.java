...
public class TreinadorController {
    ...
    public void carregarDadosIniciais() {
        ...
        } catch (java.io.IOException | Data.ValidacaoException e) {
    ...
    public Treinador criarNovoTreinador(String username) {
        try {
            ...
            if (nome.trim().isEmpty()) {
                throw new Data.ValidacaoException("O nome não pode ser vazio.");
            }
            if (!nome.matches("[a-zA-Z ]+")) {
                throw new Data.ValidacaoException("O nome deve conter apenas letras e espaços.");
            }
            ...
            if (idadeStr.trim().isEmpty()) {
                throw new Data.ValidacaoException("A idade não pode ser vazia.");
            }
            int idade = Integer.parseInt(idadeStr.trim());
            if (idade < 18 || idade > 100) {
                throw new Data.ValidacaoException("A idade deve ser um número entre 18 e 100.");
            }
        ...
        } catch (Data.ValidacaoException e) {
    ...
    public void carregarAlunos() {
        ...
        if (treinador.getAlunos() != null) {
            for (Aluno alunoInfo : treinador.getAlunos()) {
                ...
                } catch (IOException | Data.ValidacaoException e) {
